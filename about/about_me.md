...
```
在CVE、补天、CNVD、CNNVD及漏洞盒子等国内外知名漏洞报送平台上提交过多个漏洞，涵盖高危及中危漏洞，部分漏洞获得官方致谢，为安全生态建设做出积极贡献。
长期以个人身份大量参与国内外顶级CTF比赛，专注于多方向技术攻防，积累了丰富的实战经验，多次取得优异排名。
# CTF
```
精通CTF多方向全栈技术，包括Web、Pwn、逆向工程、Misc、取证和密码学等领域，能够针对不同类型题目快速分析和高效解题，同时具备全局规划和团队协作能力，在个人及团队赛事中均表现出色。
```
# 项目经历：
```
2023年6月3日-5日：红队项目
...
• 深入掌握SQL注入、XSS、CSRF、SSRF、RCE、文件上传漏洞、任意文件读取、XXE、弱口令、文件包含等Web漏洞的原理和利用方法，具有丰富的实战攻防经验。
...
• 精通无线安全技术，熟悉Wi-Fi监听、重放及加密协议破解，能够实施无线网络渗透测试。
...
• 精通日志分析与攻击溯源技术，能够通过分析攻击痕迹复现事件全过程，协助企业进行全面整改。
